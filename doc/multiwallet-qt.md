...
In order to support loading of multiple wallets in fundamental-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fundamental.cpp.
...
Changes to fundamental.cpp
----------------------
fundamental.cpp is the entry point into fundamental-qt, and as such, will require some minor modifications to provide hooks for
