                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fundamental Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fundamental address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fundamental: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFDM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fundamental Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fundamental Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fundamental"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fundamental addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fundamental addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fundamental: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fundamental Core help message to get a list with possible Fundamental command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fundamental Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fundamental network", "", count));
}
...
{
    QString strTitle = tr("Fundamental Core"); // default title
...
/** Creates context menu, its actions, and fundamentals up all the relevant signals for mouse events. */
