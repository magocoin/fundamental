...
/** Utility functions used by the Fundamental Qt UI.
 */
namespace GUIUtil
{
...
// Render Fundamental addresses in monospace font
...
// Parse "fundamental:" URI into recipient object, return true on successful parsing
