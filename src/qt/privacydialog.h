...
public:
    ...
    void setZFundamentalControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzFDM_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzFDM_clicked();
    void on_pushButtonZFundamentalControl_clicked();
