                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Fundamental from zFDM"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zFDM"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zFDM));
