...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Fundamental Core"),
     ...
     * override -datadir in the fundamental.conf file in the default data directory
     * (to be consistent with fundamentald behavior)
     */
    if (dataDir != getDefaultDataDirectory())
