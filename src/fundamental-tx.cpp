...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fundamental Core fundamental-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fundamental-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fundamental transaction") + "\n" +
                               "  fundamental-tx [options] -create [commands]   " + _("Create hex-encoded fundamental transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fundamental transaction
