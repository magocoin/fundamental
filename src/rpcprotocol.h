...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Fundamental is not connected
    ...
    RPC_WALLET_PASSFDMIPCOINASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
