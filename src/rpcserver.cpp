...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Fundamental server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Fundamental server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"fundamental", "masternode", &masternode, true, true, false},
        {"fundamental", "listmasternodes", &listmasternodes, true, true, false},
        {"fundamental", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fundamental", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fundamental", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fundamental", "masternodedebug", &masternodedebug, true, true, false},
        {"fundamental", "startmasternode", &startmasternode, true, true, false},
        {"fundamental", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fundamental", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fundamental", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fundamental", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fundamental", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fundamental", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fundamental", "mnbudget", &mnbudget, true, true, false},
        {"fundamental", "preparebudget", &preparebudget, true, true, false},
        {"fundamental", "submitbudget", &submitbudget, true, true, false},
        {"fundamental", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fundamental", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fundamental", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fundamental", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fundamental", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fundamental", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fundamental", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fundamental", "checkbudgets", &checkbudgets, true, true, false},
        {"fundamental", "mnsync", &mnsync, true, true, false},
        {"fundamental", "spork", &spork, true, true, false},
        {"fundamental", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fundamental", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fundamentald, or the -server option to fundamental-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fundamental-cli " + methodname + " " + args + "\n";
}
