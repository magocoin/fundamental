Contributing to Fundamental Core
============================

The Fundamental Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fundamental Core project, and is not to be
confused with overall Fundamental Network Protocol consensus changes.

Whether a pull request is merged into Fundamental Core rests with the project merge
...
Patches that change Fundamental consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fundamental consensus, it must have been
...
The project leader is the release manager for each Fundamental Core release.
