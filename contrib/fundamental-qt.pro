...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/fundamental-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/fundamental-cli.cpp \
           src/fundamental-tx.cpp \
           src/fundamental.cpp \
           src/db.cpp \
           ...
           src/qt/fundamental.cpp \
           src/qt/fundamentalstrings.cpp \
...
RESOURCES += src/qt/fundamental.qrc src/qt/fundamental_locale.qrc

TRANSLATIONS += src/qt/locale/fundamental_bg.ts \
                src/qt/locale/fundamental_de.ts \
                src/qt/locale/fundamental_en.ts \
                src/qt/locale/fundamental_es.ts \
                src/qt/locale/fundamental_fi.ts \
                src/qt/locale/fundamental_fr.ts \
                src/qt/locale/fundamental_it.ts \
                src/qt/locale/fundamental_ja.ts \
                src/qt/locale/fundamental_pl.ts \
                src/qt/locale/fundamental_pt.ts \
                src/qt/locale/fundamental_ru.ts \
                src/qt/locale/fundamental_sk.ts \
                src/qt/locale/fundamental_sv.ts \
                src/qt/locale/fundamental_vi.ts \
                src/qt/locale/fundamental_zh_CN.ts \
                src/qt/locale/fundamental_zh_TW.ts
